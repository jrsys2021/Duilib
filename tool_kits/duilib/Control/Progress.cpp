...
uint64_t Progress::GetMinValue() const
{
	return m_nMin;
}

void Progress::SetMinValue(uint64_t nMin)
{
	m_nMin = nMin;
	Invalidate();
}

uint64_t Progress::GetMaxValue() const
{
	return m_nMax;
}

void Progress::SetMaxValue(uint64_t nMax)
{
	m_nMax = nMax;
	Invalidate();
}

uint64_t Progress::GetValue() const
{
	return m_nValue;
}

void Progress::SetValue(uint64_t nValue)
{
	m_nValue = nValue;
	Invalidate();
}
